        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(check){
                    ...
                    details=new PropertyDetails(user.getUid(),nameString,priceString,modelString,areaString,dimensionString,floorString,docksString,addressString,extraString);
                    ...
                    firestore.collection("PropertyDetails").document(documentId).set(details).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void avoid) {
                            Toast.makeText(CreateProperty.this, "Your data has been saved", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(CreateProperty.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        }
                    });
               }
...
//        intent.setAction(Intent.ACTION_GET_CONTENT);
    ...
    public void uploadImage(Uri uri,String fileName,int index){
        //Toast.makeText(this, "Wait,the photo is being uploaded....", Toast.LENGTH_SHORT).show();
        progressDialog.setMessage("Wait the photo is being uploaded");
        progressDialog.setCancelable(false);
        progressDialog.show();
        storageReference=FirebaseStorage.getInstance().getReference().child(user.getUid()).child(fileName).child(nameOfViewsArray[index]);
        storageReference.putFile(uri).addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(CreateProperty.this,"Successfully Uploaded ",Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CreateProperty.this,MainActivity.class));
        finish();
    }
}